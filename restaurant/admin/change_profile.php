...
<body>
  ...
  <div class="main-content">
    ...
    ?>
      <!-- Header -->
      <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(assets/img/theme/hotel-1191718_1920.jpg); background-size: cover; background-position: center top;">
        <!-- Mask -->
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="password" name="old_password" id="admin_password" class="form-control form-control-alternative">
                        </div>
                      </div>
